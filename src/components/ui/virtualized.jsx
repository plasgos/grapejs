...
const Virtualized = React.forwardRef((props, ref) => {
...
const VirtualizedList = React.forwardRef(({ orientation = "vertical", ...props }, ref) => {
...
const VirtualizedVirtualizer = React.forwardRef((props, ref) => {
