...
const BgLightGradient2 = () => {
  return (
    <div className="absolute top-0 z-[-2] h-full w-screen rotate-180 transform bg-white bg-[radial-gradient(60%_120%_at_50%_50%,hsla(0,0%,100%,0)_0,rgba(252,205,238,.5)_100%)]" />
  );
};
...
const BgLightGradient3 = () => {
  return (
    <div className="absolute top-0 z-[-2] h-full w-screen bg-white bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]" />
  );
};
...
const BgDarkGrid1 = () => {
  return (
    <div className="absolute top-0 z-[-2] h-full w-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px]" />
  );
};
...
export const MODERN_BACKGROUND_OPTIONS = [
  {
